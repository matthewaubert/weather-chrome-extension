...
/* harmony export */   "default": () => (/* binding */ setBadge)
/* harmony export */ });
/* harmony import */ var _maps_color_map_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./maps/color-map.js */ "./src/maps/color-map.js");
/* global chrome */

function setBadge(data, system) {
  var schemeKeyword = _maps_color_map_js__WEBPACK_IMPORTED_MODULE_0__["default"][data.isDayOrNight()][data.condition.code];
  chrome.action.setBadgeBackgroundColor({
    color: _maps_color_map_js__WEBPACK_IMPORTED_MODULE_0__["default"].schemes[schemeKeyword].badge
  });
  chrome.action.setBadgeText({
    text: "".concat(data["temp".concat(system.temp)], "\xB0")
  });
}
...
/* harmony export */   serializeLocation: () => (/* binding */ serializeLocation),
/* harmony export */   serializeSystem: () => (/* binding */ serializeSystem),
...
function storageAvailable(_x) {
  return _storageAvailable.apply(this, arguments);
} // store location in local storage
function _storageAvailable() {
  _storageAvailable = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(type) {
    var storage, x;
...
function _deserialize() {
  _deserialize = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(key) {
    var result;
...
var CurrentWeather = /*#__PURE__*/function () {
  function CurrentWeather(chanceOfRain, cloud, condition, feelsLikeC, feelsLikeF, humidity, isDay, location, maxTempC, maxTempF, minTempC, minTempF, moonPhase, sunrise, sunset, tempC, tempF, time, uv, windDegree, windKph, windMph) {
...
function _toPrimitive(t, r) { if ("object" != _typeof(t) || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != _typeof(i)) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
var Forecast = /*#__PURE__*/_createClass(function Forecast(condition, date, maxTempC, maxTempF, minTempC, minTempF) {
...
var System = /*#__PURE__*/function () {
  ...
  _createClass(System, [{
    ...
    function switchSystem() {
      var _this = this;
      var newSystem = this.name === 'imperial' ? 'metric' : 'imperial';
      Object.keys(this).forEach(function (key) {
        _this[key] = System[newSystem][key];
      });
    }
  }], [{
    key: "getNewSystem",
    ...
    function getNewSystem(systemName) {
      return new System(System[systemName]);
    }
  }]);
  return System;
}();
_defineProperty(System, "imperial", {
  name: 'imperial',
  temp: 'F',
  speed: 'Mph'
});
_defineProperty(System, "metric", {
  name: 'metric',
  temp: 'C',
  speed: 'Kph'
});
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (wiMap);
...
/* harmony import */ var _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./maps/dom.js */ "./src/maps/dom.js");
...
function renderError(err) {
  _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].errorDisplay.innerText = err;
}

// clear error message from error display element
function clearError() {
  _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].errorDisplay.innerText = '';
}

// run all render funcs to display weather data
function renderWeather(data, system) {
...
function renderLocation(data) {
  _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].location.city.innerText = data.location.city;
  _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].location.region.innerText = data.location.region ? "".concat(data.location.region, ",") : '';
  _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].location.country.innerText = data.location.country;
  _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].location.time.innerText = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.format)(data.time, 'PPPPp');
}

// render primary current weather info
function renderCurrentWeatherPrimary(data, system) {
  _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].current.icon.innerText = data.isDay ? _maps_wi_map_js__WEBPACK_IMPORTED_MODULE_0__["default"].day[data.condition.code] : _maps_wi_map_js__WEBPACK_IMPORTED_MODULE_0__["default"].night[data.condition.code]; // render icon
  _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].current.text.innerText = data.condition.text; // render condition text
  _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].current.temp.innerText = "".concat(data["temp".concat(system.temp)], "\xB0").concat(system.temp); // render current temp
  _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].current.feelsLike.innerText = "Feels like ".concat(data["feelsLike".concat(system.temp)], "\xB0").concat(system.temp); // render current feelslike
}

// render secondary current weather info
function renderCurrentWeatherSecondary(data, system) {
  _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].today.highLow.innerText = "".concat(data["maxTemp".concat(system.temp)], "\xB0 / ").concat(data["minTemp".concat(system.temp)], "\xB0");
  _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].today.precip.innerText = "".concat(data.chanceOfRain, "%");
  _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].today.humidity.innerText = "".concat(data.humidity, "%");
  _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].today.wind.innerText = "".concat(data["wind".concat(system.speed)], " ").concat(system.speed.toLowerCase());
  _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].today.cloud.innerText = "".concat(data.cloud, "%");
  _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].today.uv.innerText = "".concat(data.uv, " of 11");
  _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].today.sunrise.innerText = data.sunrise;
  _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].today.sunset.innerText = data.sunset;
  _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].today.moonPhase.innerText = _maps_wi_map_js__WEBPACK_IMPORTED_MODULE_0__["default"].moonPhase[data.moonPhase];
}

// render forecast weather info
function renderForecast(data, system) {
  // iterate over each day in forecast
  _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].forecast.forEach(function (day, i) {
    // render title
...
function renderColorScheme(data) {
  var colorScheme = _maps_color_map_js__WEBPACK_IMPORTED_MODULE_1__["default"].schemes[_maps_color_map_js__WEBPACK_IMPORTED_MODULE_1__["default"][data.isDayOrNight()][data.condition.code]];
  _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].root.style.setProperty('--bg-gradient', colorScheme.bg);
  _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].root.style.setProperty('--search-bar', colorScheme.searchBar);
  _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].root.style.setProperty('--text-light', colorScheme.textLight);
}

// toggle backdrop and spinner
function toggleLoadComponent() {
  Object.keys(_maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].loadComponent).forEach(function (el) {
    _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].loadComponent[el].classList.toggle('visible');
  });
}
...
/* harmony import */ var _classes_current_weather_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./classes/current-weather.js */ "./src/classes/current-weather.js");
/* harmony import */ var _classes_forecast_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./classes/forecast.js */ "./src/classes/forecast.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _regeneratorRuntime() { "use strict"; /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ _regeneratorRuntime = function _regeneratorRuntime() { return e; }; var t, e = {}, r = Object.prototype, n = r.hasOwnProperty, o = Object.defineProperty || function (t, e, r) { t[e] = r.value; }, i = "function" == typeof Symbol ? Symbol : {}, a = i.iterator || "@@iterator", c = i.asyncIterator || "@@asyncIterator", u = i.toStringTag || "@@toStringTag"; function define(t, e, r) { return Object.defineProperty(t, e, { value: r, enumerable: !0, configurable: !0, writable: !0 }), t[e]; } try { define({}, ""); } catch (t) { define = function define(t, e, r) { return t[e] = r; }; } function wrap(t, e, r, n) { var i = e && e.prototype instanceof Generator ? e : Generator, a = Object.create(i.prototype), c = new Context(n || []); return o(a, "_invoke", { value: makeInvokeMethod(t, r, c) }), a; } function tryCatch(t, e, r) { try { return { type: "normal", arg: t.call(e, r) }; } catch (t) { return { type: "throw", arg: t }; } } e.wrap = wrap; var h = "suspendedStart", l = "suspendedYield", f = "executing", s = "completed", y = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} var p = {}; define(p, a, function () { return this; }); var d = Object.getPrototypeOf, v = d && d(d(values([]))); v && v !== r && n.call(v, a) && (p = v); var g = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(p); function defineIteratorMethods(t) { ["next", "throw", "return"].forEach(function (e) { define(t, e, function (t) { return this._invoke(e, t); }); }); } function AsyncIterator(t, e) { function invoke(r, o, i, a) { var c = tryCatch(t[r], t, o); if ("throw" !== c.type) { var u = c.arg, h = u.value; return h && "object" == _typeof(h) && n.call(h, "__await") ? e.resolve(h.__await).then(function (t) { invoke("next", t, i, a); }, function (t) { invoke("throw", t, i, a); }) : e.resolve(h).then(function (t) { u.value = t, i(u); }, function (t) { return invoke("throw", t, i, a); }); } a(c.arg); } var r; o(this, "_invoke", { value: function value(t, n) { function callInvokeWithMethodAndArg() { return new e(function (e, r) { invoke(t, n, e, r); }); } return r = r ? r.then(callInvokeWithMethodAndArg, callInvokeWithMethodAndArg) : callInvokeWithMethodAndArg(); } }); } function makeInvokeMethod(e, r, n) { var o = h; return function (i, a) { if (o === f) throw new Error("Generator is already running"); if (o === s) { if ("throw" === i) throw a; return { value: t, done: !0 }; } for (n.method = i, n.arg = a;;) { var c = n.delegate; if (c) { var u = maybeInvokeDelegate(c, n); if (u) { if (u === y) continue; return u; } } if ("next" === n.method) n.sent = n._sent = n.arg;else if ("throw" === n.method) { if (o === h) throw o = s, n.arg; n.dispatchException(n.arg); } else "return" === n.method && n.abrupt("return", n.arg); o = f; var p = tryCatch(e, r, n); if ("normal" === p.type) { if (o = n.done ? s : l, p.arg === y) continue; return { value: p.arg, done: n.done }; } "throw" === p.type && (o = s, n.method = "throw", n.arg = p.arg); } }; } function maybeInvokeDelegate(e, r) { var n = r.method, o = e.iterator[n]; if (o === t) return r.delegate = null, "throw" === n && e.iterator["return"] && (r.method = "return", r.arg = t, maybeInvokeDelegate(e, r), "throw" === r.method) || "return" !== n && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + n + "' method")), y; var i = tryCatch(o, e.iterator, r.arg); if ("throw" === i.type) return r.method = "throw", r.arg = i.arg, r.delegate = null, y; var a = i.arg; return a ? a.done ? (r[e.resultName] = a.value, r.next = e.nextLoc, "return" !== r.method && (r.method = "next", r.arg = t), r.delegate = null, y) : a : (r.method = "throw", r.arg = new TypeError("iterator result is not an object"), r.delegate = null, y); } function pushTryEntry(t) { var e = { tryLoc: t[0] }; 1 in t && (e.catchLoc = t[1]), 2 in t && (e.finallyLoc = t[2], e.afterLoc = t[3]), this.tryEntries.push(e); } function resetTryEntry(t) { var e = t.completion || {}; e.type = "normal", delete e.arg, t.completion = e; } function Context(t) { this.tryEntries = [{ tryLoc: "root" }], t.forEach(pushTryEntry, this), this.reset(!0); } function values(e) { if (e || "" === e) { var r = e[a]; if (r) return r.call(e); if ("function" == typeof e.next) return e; if (!isNaN(e.length)) { var o = -1, i = function next() { for (; ++o < e.length;) if (n.call(e, o)) return next.value = e[o], next.done = !1, next; return next.value = t, next.done = !0, next; }; return i.next = i; } } throw new TypeError(_typeof(e) + " is not iterable"); } return GeneratorFunction.prototype = GeneratorFunctionPrototype, o(g, "constructor", { value: GeneratorFunctionPrototype, configurable: !0 }), o(GeneratorFunctionPrototype, "constructor", { value: GeneratorFunction, configurable: !0 }), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, u, "GeneratorFunction"), e.isGeneratorFunction = function (t) { var e = "function" == typeof t && t.constructor; return !!e && (e === GeneratorFunction || "GeneratorFunction" === (e.displayName || e.name)); }, e.mark = function (t) { return Object.setPrototypeOf ? Object.setPrototypeOf(t, GeneratorFunctionPrototype) : (t.__proto__ = GeneratorFunctionPrototype, define(t, u, "GeneratorFunction")), t.prototype = Object.create(g), t; }, e.awrap = function (t) { return { __await: t }; }, defineIteratorMethods(AsyncIterator.prototype), define(AsyncIterator.prototype, c, function () { return this; }), e.AsyncIterator = AsyncIterator, e.async = function (t, r, n, o, i) { void 0 === i && (i = Promise); var a = new AsyncIterator(wrap(t, r, n, o), i); return e.isGeneratorFunction(r) ? a : a.next().then(function (t) { return t.done ? t.value : a.next(); }); }, defineIteratorMethods(g), define(g, u, "Generator"), define(g, a, function () { return this; }), define(g, "toString", function () { return "[object Generator]"; }), e.keys = function (t) { var e = Object(t), r = []; for (var n in e) r.push(n); return r.reverse(), function next() { for (; r.length;) { var t = r.pop(); if (t in e) return next.value = t, next.done = !1, next; } return next.done = !0, next; }; }, e.values = values, Context.prototype = { constructor: Context, reset: function reset(e) { if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = !1, this.delegate = null, this.method = "next", this.arg = t, this.tryEntries.forEach(resetTryEntry), !e) for (var r in this) "t" === r.charAt(0) && n.call(this, r) && !isNaN(+r.slice(1)) && (this[r] = t); }, stop: function stop() { this.done = !0; var t = this.tryEntries[0].completion; if ("throw" === t.type) throw t.arg; return this.rval; }, dispatchException: function dispatchException(e) { if (this.done) throw e; var r = this; function handle(n, o) { return a.type = "throw", a.arg = e, r.next = n, o && (r.method = "next", r.arg = t), !!o; } for (var o = this.tryEntries.length - 1; o >= 0; --o) { var i = this.tryEntries[o], a = i.completion; if ("root" === i.tryLoc) return handle("end"); if (i.tryLoc <= this.prev) { var c = n.call(i, "catchLoc"), u = n.call(i, "finallyLoc"); if (c && u) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } else if (c) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); } else { if (!u) throw new Error("try statement without catch or finally"); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } } } }, abrupt: function abrupt(t, e) { for (var r = this.tryEntries.length - 1; r >= 0; --r) { var o = this.tryEntries[r]; if (o.tryLoc <= this.prev && n.call(o, "finallyLoc") && this.prev < o.finallyLoc) { var i = o; break; } } i && ("break" === t || "continue" === t) && i.tryLoc <= e && e <= i.finallyLoc && (i = null); var a = i ? i.completion : {}; return a.type = t, a.arg = e, i ? (this.method = "next", this.next = i.finallyLoc, y) : this.complete(a); }, complete: function complete(t, e) { if ("throw" === t.type) throw t.arg; return "break" === t.type || "continue" === t.type ? this.next = t.arg : "return" === t.type ? (this.rval = this.arg = t.arg, this.method = "return", this.next = "end") : "normal" === t.type && e && (this.next = e), y; }, finish: function finish(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.finallyLoc === t) return this.complete(r.completion, r.afterLoc), resetTryEntry(r), y; } }, "catch": function _catch(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.tryLoc === t) { var n = r.completion; if ("throw" === n.type) { var o = n.arg; resetTryEntry(r); } return o; } } throw new Error("illegal catch attempt"); }, delegateYield: function delegateYield(e, r, n) { return this.delegate = { iterator: values(e), resultName: r, nextLoc: n }, "next" === this.method && (this.arg = t), y; } }, e; }
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 5:
          ...
          weatherData = processData(response.value);
...
function _fetchWeather() {
  _fetchWeather = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(location) {
    var apiKey, response, weatherData;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          apiKey = 'ab36ae6f835d44c781e191306230411';
          _context2.prev = 1;
          _context2.next = 4;
          return fetch("https://api.weatherapi.com/v1/forecast.json?key=".concat(apiKey, "&q=").concat(location, "&days=3"), {
            mode: 'cors'
          });
        case 4:
...
function processData(weatherData) {
  var current = new _classes_current_weather_js__WEBPACK_IMPORTED_MODULE_0__["default"](weatherData.forecast.forecastday[0].day.daily_chance_of_rain, weatherData.current.cloud, {
    code: weatherData.current.condition.code,
    text: weatherData.current.condition.text
  },
  // weatherData.current.condition,
  Math.round(weatherData.current.feelslike_c), Math.round(weatherData.current.feelslike_f), weatherData.current.humidity, weatherData.current.is_day === 1, {
    city: weatherData.location.name,
    country: formatCountry(weatherData.location.country),
    region: weatherData.location.region
  }, Math.round(weatherData.forecast.forecastday[0].day.maxtemp_c), Math.round(weatherData.forecast.forecastday[0].day.maxtemp_f), Math.round(weatherData.forecast.forecastday[0].day.mintemp_c), Math.round(weatherData.forecast.forecastday[0].day.mintemp_f), weatherData.forecast.forecastday[0].astro.moon_phase, weatherData.forecast.forecastday[0].astro.sunrise, weatherData.forecast.forecastday[0].astro.sunset, Math.round(weatherData.current.temp_c), Math.round(weatherData.current.temp_f), (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.parse)(weatherData.location.localtime, 'yyyy-MM-dd HH:mm', new Date()), weatherData.current.uv, weatherData.current.wind_degree, Math.round(weatherData.current.wind_kph), Math.round(weatherData.current.wind_mph));
  var forecast = [];
  // iterate over all forecast days
  weatherData.forecast.forecastday.forEach(function (day) {
    // create new Forecast instance and push to forecasts array
    forecast.push(new _classes_forecast_js__WEBPACK_IMPORTED_MODULE_1__["default"]({
      code: day.day.condition.code,
      text: day.day.condition.text
    }, (0,date_fns__WEBPACK_IMPORTED_MODULE_2__.parse)(day.date, 'yyyy-MM-dd', new Date()), Math.round(day.day.maxtemp_c), Math.round(day.day.maxtemp_f), Math.round(day.day.mintemp_c), Math.round(day.day.mintemp_f)));
  });
  return {
    current: current,
    forecast: forecast
...
/* harmony import */ var _classes_system_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./classes/system.js */ "./src/classes/system.js");
/* harmony import */ var _maps_dom_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./maps/dom.js */ "./src/maps/dom.js");
/* harmony import */ var _chrome_storage_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./chrome-storage.js */ "./src/chrome-storage.js");
/* harmony import */ var _action_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./action.js */ "./src/action.js");
function _typeof(o) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (o) { return typeof o; } : function (o) { return o && "function" == typeof Symbol && o.constructor === Symbol && o !== Symbol.prototype ? "symbol" : typeof o; }, _typeof(o); }
function _regeneratorRuntime() { "use strict"; /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/facebook/regenerator/blob/main/LICENSE */ _regeneratorRuntime = function _regeneratorRuntime() { return e; }; var t, e = {}, r = Object.prototype, n = r.hasOwnProperty, o = Object.defineProperty || function (t, e, r) { t[e] = r.value; }, i = "function" == typeof Symbol ? Symbol : {}, a = i.iterator || "@@iterator", c = i.asyncIterator || "@@asyncIterator", u = i.toStringTag || "@@toStringTag"; function define(t, e, r) { return Object.defineProperty(t, e, { value: r, enumerable: !0, configurable: !0, writable: !0 }), t[e]; } try { define({}, ""); } catch (t) { define = function define(t, e, r) { return t[e] = r; }; } function wrap(t, e, r, n) { var i = e && e.prototype instanceof Generator ? e : Generator, a = Object.create(i.prototype), c = new Context(n || []); return o(a, "_invoke", { value: makeInvokeMethod(t, r, c) }), a; } function tryCatch(t, e, r) { try { return { type: "normal", arg: t.call(e, r) }; } catch (t) { return { type: "throw", arg: t }; } } e.wrap = wrap; var h = "suspendedStart", l = "suspendedYield", f = "executing", s = "completed", y = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} var p = {}; define(p, a, function () { return this; }); var d = Object.getPrototypeOf, v = d && d(d(values([]))); v && v !== r && n.call(v, a) && (p = v); var g = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(p); function defineIteratorMethods(t) { ["next", "throw", "return"].forEach(function (e) { define(t, e, function (t) { return this._invoke(e, t); }); }); } function AsyncIterator(t, e) { function invoke(r, o, i, a) { var c = tryCatch(t[r], t, o); if ("throw" !== c.type) { var u = c.arg, h = u.value; return h && "object" == _typeof(h) && n.call(h, "__await") ? e.resolve(h.__await).then(function (t) { invoke("next", t, i, a); }, function (t) { invoke("throw", t, i, a); }) : e.resolve(h).then(function (t) { u.value = t, i(u); }, function (t) { return invoke("throw", t, i, a); }); } a(c.arg); } var r; o(this, "_invoke", { value: function value(t, n) { function callInvokeWithMethodAndArg() { return new e(function (e, r) { invoke(t, n, e, r); }); } return r = r ? r.then(callInvokeWithMethodAndArg, callInvokeWithMethodAndArg) : callInvokeWithMethodAndArg(); } }); } function makeInvokeMethod(e, r, n) { var o = h; return function (i, a) { if (o === f) throw new Error("Generator is already running"); if (o === s) { if ("throw" === i) throw a; return { value: t, done: !0 }; } for (n.method = i, n.arg = a;;) { var c = n.delegate; if (c) { var u = maybeInvokeDelegate(c, n); if (u) { if (u === y) continue; return u; } } if ("next" === n.method) n.sent = n._sent = n.arg;else if ("throw" === n.method) { if (o === h) throw o = s, n.arg; n.dispatchException(n.arg); } else "return" === n.method && n.abrupt("return", n.arg); o = f; var p = tryCatch(e, r, n); if ("normal" === p.type) { if (o = n.done ? s : l, p.arg === y) continue; return { value: p.arg, done: n.done }; } "throw" === p.type && (o = s, n.method = "throw", n.arg = p.arg); } }; } function maybeInvokeDelegate(e, r) { var n = r.method, o = e.iterator[n]; if (o === t) return r.delegate = null, "throw" === n && e.iterator["return"] && (r.method = "return", r.arg = t, maybeInvokeDelegate(e, r), "throw" === r.method) || "return" !== n && (r.method = "throw", r.arg = new TypeError("The iterator does not provide a '" + n + "' method")), y; var i = tryCatch(o, e.iterator, r.arg); if ("throw" === i.type) return r.method = "throw", r.arg = i.arg, r.delegate = null, y; var a = i.arg; return a ? a.done ? (r[e.resultName] = a.value, r.next = e.nextLoc, "return" !== r.method && (r.method = "next", r.arg = t), r.delegate = null, y) : a : (r.method = "throw", r.arg = new TypeError("iterator result is not an object"), r.delegate = null, y); } function pushTryEntry(t) { var e = { tryLoc: t[0] }; 1 in t && (e.catchLoc = t[1]), 2 in t && (e.finallyLoc = t[2], e.afterLoc = t[3]), this.tryEntries.push(e); } function resetTryEntry(t) { var e = t.completion || {}; e.type = "normal", delete e.arg, t.completion = e; } function Context(t) { this.tryEntries = [{ tryLoc: "root" }], t.forEach(pushTryEntry, this), this.reset(!0); } function values(e) { if (e || "" === e) { var r = e[a]; if (r) return r.call(e); if ("function" == typeof e.next) return e; if (!isNaN(e.length)) { var o = -1, i = function next() { for (; ++o < e.length;) if (n.call(e, o)) return next.value = e[o], next.done = !1, next; return next.value = t, next.done = !0, next; }; return i.next = i; } } throw new TypeError(_typeof(e) + " is not iterable"); } return GeneratorFunction.prototype = GeneratorFunctionPrototype, o(g, "constructor", { value: GeneratorFunctionPrototype, configurable: !0 }), o(GeneratorFunctionPrototype, "constructor", { value: GeneratorFunction, configurable: !0 }), GeneratorFunction.displayName = define(GeneratorFunctionPrototype, u, "GeneratorFunction"), e.isGeneratorFunction = function (t) { var e = "function" == typeof t && t.constructor; return !!e && (e === GeneratorFunction || "GeneratorFunction" === (e.displayName || e.name)); }, e.mark = function (t) { return Object.setPrototypeOf ? Object.setPrototypeOf(t, GeneratorFunctionPrototype) : (t.__proto__ = GeneratorFunctionPrototype, define(t, u, "GeneratorFunction")), t.prototype = Object.create(g), t; }, e.awrap = function (t) { return { __await: t }; }, defineIteratorMethods(AsyncIterator.prototype), define(AsyncIterator.prototype, c, function () { return this; }), e.AsyncIterator = AsyncIterator, e.async = function (t, r, n, o, i) { void 0 === i && (i = Promise); var a = new AsyncIterator(wrap(t, r, n, o), i); return e.isGeneratorFunction(r) ? a : a.next().then(function (t) { return t.done ? t.value : a.next(); }); }, defineIteratorMethods(g), define(g, u, "Generator"), define(g, a, function () { return this; }), define(g, "toString", function () { return "[object Generator]"; }), e.keys = function (t) { var e = Object(t), r = []; for (var n in e) r.push(n); return r.reverse(), function next() { for (; r.length;) { var t = r.pop(); if (t in e) return next.value = t, next.done = !1, next; } return next.done = !0, next; }; }, e.values = values, Context.prototype = { constructor: Context, reset: function reset(e) { if (this.prev = 0, this.next = 0, this.sent = this._sent = t, this.done = !1, this.delegate = null, this.method = "next", this.arg = t, this.tryEntries.forEach(resetTryEntry), !e) for (var r in this) "t" === r.charAt(0) && n.call(this, r) && !isNaN(+r.slice(1)) && (this[r] = t); }, stop: function stop() { this.done = !0; var t = this.tryEntries[0].completion; if ("throw" === t.type) throw t.arg; return this.rval; }, dispatchException: function dispatchException(e) { if (this.done) throw e; var r = this; function handle(n, o) { return a.type = "throw", a.arg = e, r.next = n, o && (r.method = "next", r.arg = t), !!o; } for (var o = this.tryEntries.length - 1; o >= 0; --o) { var i = this.tryEntries[o], a = i.completion; if ("root" === i.tryLoc) return handle("end"); if (i.tryLoc <= this.prev) { var c = n.call(i, "catchLoc"), u = n.call(i, "finallyLoc"); if (c && u) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } else if (c) { if (this.prev < i.catchLoc) return handle(i.catchLoc, !0); } else { if (!u) throw new Error("try statement without catch or finally"); if (this.prev < i.finallyLoc) return handle(i.finallyLoc); } } } }, abrupt: function abrupt(t, e) { for (var r = this.tryEntries.length - 1; r >= 0; --r) { var o = this.tryEntries[r]; if (o.tryLoc <= this.prev && n.call(o, "finallyLoc") && this.prev < o.finallyLoc) { var i = o; break; } } i && ("break" === t || "continue" === t) && i.tryLoc <= e && e <= i.finallyLoc && (i = null); var a = i ? i.completion : {}; return a.type = t, a.arg = e, i ? (this.method = "next", this.next = i.finallyLoc, y) : this.complete(a); }, complete: function complete(t, e) { if ("throw" === t.type) throw t.arg; return "break" === t.type || "continue" === t.type ? this.next = t.arg : "return" === t.type ? (this.rval = this.arg = t.arg, this.method = "return", this.next = "end") : "normal" === t.type && e && (this.next = e), y; }, finish: function finish(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.finallyLoc === t) return this.complete(r.completion, r.afterLoc), resetTryEntry(r), y; } }, "catch": function _catch(t) { for (var e = this.tryEntries.length - 1; e >= 0; --e) { var r = this.tryEntries[e]; if (r.tryLoc === t) { var n = r.completion; if ("throw" === n.type) { var o = n.arg; resetTryEntry(r); } return o; } } throw new Error("illegal catch attempt"); }, delegateYield: function delegateYield(e, r, n) { return this.delegate = { iterator: values(e), resultName: r, nextLoc: n }, "next" === this.method && (this.arg = t), y; } }, e; }
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
...
_maps_dom_js__WEBPACK_IMPORTED_MODULE_3__["default"].form.form.addEventListener('submit', handleSearch);
_maps_dom_js__WEBPACK_IMPORTED_MODULE_3__["default"].systemToggle.addEventListener('change', switchSystem);
  ...
  _initApp = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return (0,_chrome_storage_js__WEBPACK_IMPORTED_MODULE_4__.storageAvailable)('local');
        case 2:
          ...
          _context.next = 6;
          return (0,_chrome_storage_js__WEBPACK_IMPORTED_MODULE_4__.deserialize)('wceSystem');
        case 6:
          _context.t0 = _context.sent;
        case 7:
          if (!_context.t0) {
          ...
          _context.t1 = _classes_system_js__WEBPACK_IMPORTED_MODULE_2__["default"];
          _context.next = 11;
          return (0,_chrome_storage_js__WEBPACK_IMPORTED_MODULE_4__.deserialize)('wceSystem');
        case 11:
          _context.t2 = _context.sent;
          currentSystem = _context.t1.getNewSystem.call(_context.t1, _context.t2);
          if (currentSystem.name === 'metric') _maps_dom_js__WEBPACK_IMPORTED_MODULE_3__["default"].systemToggle.checked = true;
          _context.next = 18;
          break;
        case 16:
          currentSystem = _classes_system_js__WEBPACK_IMPORTED_MODULE_2__["default"].getNewSystem('imperial');
          _maps_dom_js__WEBPACK_IMPORTED_MODULE_3__["default"].systemToggle.checked = false;
        case 18:
          _context.next = 20;
          return (0,_chrome_storage_js__WEBPACK_IMPORTED_MODULE_4__.storageAvailable)('local');
        case 20:
          ...
          _context.next = 24;
          return (0,_chrome_storage_js__WEBPACK_IMPORTED_MODULE_4__.deserialize)('wceLocation');
        case 24:
          _context.t3 = _context.sent;
        case 25:
          if (!_context.t3) {
...
function _showWeather() {
  _showWeather = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(location) {
    var weatherData;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
        ...
        case 3:
          ...
          (0,_render_js__WEBPACK_IMPORTED_MODULE_1__.clearError)();
          weatherDataCache = weatherData;
          (0,_render_js__WEBPACK_IMPORTED_MODULE_1__["default"])(weatherDataCache, currentSystem);
          (0,_action_js__WEBPACK_IMPORTED_MODULE_5__["default"])(weatherDataCache.current, currentSystem);
          _context2.next = 11;
          return (0,_chrome_storage_js__WEBPACK_IMPORTED_MODULE_4__.storageAvailable)('local');
        case 11:
          if (!_context2.sent) {
          ...
          (0,_chrome_storage_js__WEBPACK_IMPORTED_MODULE_4__.serializeLocation)(location);
        case 13:
          _context2.next = 16;
          break;
        case 15:
          (0,_render_js__WEBPACK_IMPORTED_MODULE_1__.renderError)(weatherData.error);
        case 16:
...
function handleSearch(e) {
  e.preventDefault();
  showWeather(_maps_dom_js__WEBPACK_IMPORTED_MODULE_3__["default"].form.searchInput.value);
}

// switch system between imperial and metric
function switchSystem() {
  return _switchSystem.apply(this, arguments);
}
function _switchSystem() {
  _switchSystem = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 5:
          ...
          (0,_chrome_storage_js__WEBPACK_IMPORTED_MODULE_4__.serializeSystem)(currentSystem.name);
        case 7:
        case "end":
