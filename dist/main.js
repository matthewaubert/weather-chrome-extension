...
var CurrentWeather = /*#__PURE__*/_createClass(function CurrentWeather(chanceOfRain, cloud, condition, feelsLikeC, feelsLikeF, humidity, isDay, location, maxTempC, maxTempF, minTempC, minTempF, moonPhase, sunrise, sunset, tempC, tempF, time, uv, windDegree, windKph, windMph) {
...
function renderColorScheme(data) {
  ...
  _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].root.style.setProperty('--bg-gradient', colors[_maps_color_map_js__WEBPACK_IMPORTED_MODULE_1__["default"][dayOrNight][data.condition.code]].bg);
  _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].root.style.setProperty('--search-bar', colors[_maps_color_map_js__WEBPACK_IMPORTED_MODULE_1__["default"][dayOrNight][data.condition.code]].searchBar);
  _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].root.style.setProperty('--text-light', colors[_maps_color_map_js__WEBPACK_IMPORTED_MODULE_1__["default"][dayOrNight][data.condition.code]].textLight);
}
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          if (weatherData !== null) {
            ...
            (0,_render_js__WEBPACK_IMPORTED_MODULE_1__["default"])(weatherData, currentSystem);
