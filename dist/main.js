...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   deserializeLocation: () => (/* binding */ deserializeLocation),
/* harmony export */   deserializeSystem: () => (/* binding */ deserializeSystem),
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 5:
          ...
          weatherData = processData(response);
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 14:
          ...
          _maps_dom_js__WEBPACK_IMPORTED_MODULE_2__["default"].errorDisplay.innerText = _context2.t0;
...
function processData(weatherData) {
  ...
  }, Math.round(weatherData.forecast.forecastday[0].day.maxtemp_c), Math.round(weatherData.forecast.forecastday[0].day.maxtemp_f), Math.round(weatherData.forecast.forecastday[0].day.mintemp_c), Math.round(weatherData.forecast.forecastday[0].day.mintemp_f), weatherData.forecast.forecastday[0].astro.moon_phase, weatherData.forecast.forecastday[0].astro.sunrise, weatherData.forecast.forecastday[0].astro.sunset, Math.round(weatherData.current.temp_c), Math.round(weatherData.current.temp_f), (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.parse)(weatherData.location.localtime, 'yyyy-MM-dd HH:mm', new Date()), weatherData.current.uv, weatherData.current.wind_degree, Math.round(weatherData.current.wind_kph), Math.round(weatherData.current.wind_mph));
  var forecast = [];
  ...
  weatherData.forecast.forecastday.forEach(function (day) {
    ...
    }, (0,date_fns__WEBPACK_IMPORTED_MODULE_3__.parse)(day.date, 'yyyy-MM-dd', new Date()), Math.round(day.day.maxtemp_c), Math.round(day.day.maxtemp_f), Math.round(day.day.mintemp_c), Math.round(day.day.mintemp_f)));
  });
  return {
    current: current,
    forecast: forecast
...
function initApp() {
  ...
  if ((0,_local_storage_js__WEBPACK_IMPORTED_MODULE_4__.storageAvailable)('localStorage') && localStorage.getItem('wceSystem')) {
    // if system is metric, check slider and return metric
    currentSystem = _classes_system_js__WEBPACK_IMPORTED_MODULE_2__["default"].getNewSystem((0,_local_storage_js__WEBPACK_IMPORTED_MODULE_4__.deserializeSystem)());
  ...
  if ((0,_local_storage_js__WEBPACK_IMPORTED_MODULE_4__.storageAvailable)('localStorage') && localStorage.getItem('wceLocation')) {
    showWeather((0,_local_storage_js__WEBPACK_IMPORTED_MODULE_4__.deserializeLocation)());
  } else {
...
function _showWeather() {
  _showWeather = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(location) {
    var weatherData;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
        ...
        case 3:
          ...
          if (weatherData !== null) {
            ...
            if ((0,_local_storage_js__WEBPACK_IMPORTED_MODULE_4__.storageAvailable)('localStorage')) (0,_local_storage_js__WEBPACK_IMPORTED_MODULE_4__.serializeLocation)(location); // cache location in localStorage
          }
...
function switchSystem() {
  ...
  (0,_render_js__WEBPACK_IMPORTED_MODULE_1__["default"])(weatherDataCache, currentSystem);
  (0,_action_js__WEBPACK_IMPORTED_MODULE_5__["default"])(weatherDataCache.current, currentSystem);
  if ((0,_local_storage_js__WEBPACK_IMPORTED_MODULE_4__.storageAvailable)('localStorage')) (0,_local_storage_js__WEBPACK_IMPORTED_MODULE_4__.serializeSystem)(currentSystem.name); // cache system name in localStorage
}
})();
