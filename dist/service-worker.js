...
/*!*******************************!*\
  ...
  \*******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _chrome_storage_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./chrome-storage.js */ "./src/chrome-storage.js");
/* harmony import */ var _classes_system_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./classes/system.js */ "./src/classes/system.js");
/* harmony import */ var _weather_data_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./weather-data.js */ "./src/weather-data.js");
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(_ref) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          _context.next = 5;
          return chrome.alarms.create('badge-update', {
            delayInMinutes: 20,
            periodInMinutes: 20
          });
        case 5:
...
chrome.alarms.onAlarm.addListener( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
  var system, location, weatherData;
  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      case 0:
        if (!(0,_chrome_storage_js__WEBPACK_IMPORTED_MODULE_0__.storageAvailable)('local')) {
          _context2.next = 27;
          break;
        }
        _context2.next = 3;
        return (0,_chrome_storage_js__WEBPACK_IMPORTED_MODULE_0__.deserialize)('wceSystem');
      case 3:
        if (!_context2.sent) {
          _context2.next = 11;
          break;
        }
        _context2.t1 = _classes_system_js__WEBPACK_IMPORTED_MODULE_1__["default"];
        _context2.next = 7;
        return (0,_chrome_storage_js__WEBPACK_IMPORTED_MODULE_0__.deserialize)('wceSystem');
      case 7:
        _context2.t2 = _context2.sent;
        _context2.t0 = _context2.t1.getNewSystem.call(_context2.t1, _context2.t2);
        _context2.next = 12;
        break;
      case 11:
        _context2.t0 = _classes_system_js__WEBPACK_IMPORTED_MODULE_1__["default"].getNewSystem('imperial');
      case 12:
        system = _context2.t0;
        _context2.next = 15;
        return (0,_chrome_storage_js__WEBPACK_IMPORTED_MODULE_0__.deserialize)('wceLocation');
      case 15:
        if (!_context2.sent) {
          _context2.next = 21;
          break;
      ...
      case 18:
        ...
        break;
      case 21:
        _context2.t3 = 'philadelphia';
      case 22:
        location = _context2.t3;
        _context2.next = 25;
        return (0,_weather_data_js__WEBPACK_IMPORTED_MODULE_2__["default"])(location);
      case 25:
        weatherData = _context2.sent;
        // get weather
        if (!weatherData.error) {
          (0,_action_js__WEBPACK_IMPORTED_MODULE_3__["default"])(weatherData.current, system); // set badge
        }
      case 27:
      case "end":
        return _context2.stop();
