...
/*!*******************************!*\
  ...
  \*******************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _local_storage_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./local-storage.js */ "./src/local-storage.js");
...
chrome.alarms.onAlarm.addListener( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
  ...
  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
    while (1) switch (_context2.prev = _context2.next) {
      case 0:
        console.log((0,_local_storage_js__WEBPACK_IMPORTED_MODULE_0__.storageAvailable)('localStorage'));
        if (!(0,_local_storage_js__WEBPACK_IMPORTED_MODULE_0__.storageAvailable)('localStorage')) {
          _context2.next = 9;
          break;
        }
        console.log('hello world');
        // get system from localStorage
        system = localStorage.getItem('wceSystem') ? _classes_system_js__WEBPACK_IMPORTED_MODULE_1__["default"].getNewSystem((0,_local_storage_js__WEBPACK_IMPORTED_MODULE_0__.deserializeSystem)()) : _classes_system_js__WEBPACK_IMPORTED_MODULE_1__["default"].getNewSystem('imperial'); // get location from localStorage
        location = localStorage.getItem('wceLocation') ? (0,_local_storage_js__WEBPACK_IMPORTED_MODULE_0__.deserializeLocation)() : 'philadelphia';
        _context2.next = 7;
